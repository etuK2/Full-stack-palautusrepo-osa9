...
const Part = ({ part }: { part: CoursePart }) => {
  switch (part.kind) {
    ...
    case "background":
      return <p><strong>{part.name} {part.exerciseCount}</strong><br /><i>{part.description}</i><br />submit to {part.backgroundMaterial}</p>;
    case "special":
      return <p><strong>{part.name} {part.exerciseCount}</strong><br /><i>{part.description}</i><br />required skills: {part.requirements.join(", ")}</p>;
    default:
